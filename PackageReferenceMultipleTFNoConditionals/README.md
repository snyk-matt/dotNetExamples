This is an example .NET app that has dependencies managed by `PackageReference` in project file. It uses multiple target frameworks but no conditionals to narrow dependency per target framework.
